...
class Pendulum(gym.Env):
    ...
    * v0: Initial versions release
    ...
    def __init__(self, render_mode: Optional[str] = None, g=10.0):
        ...
        self.torque_constr = 0.3
        self.thetadot_constr = 0.5
    ...
    def step(self, u):
        ...
        tot, single = self.parser.compute_robustness_dense(self.past_tau_trajectory)
    ...
    def _get_obs(self, next_state, action):
        ...
        if len(self.past_tau_trajectory) == 0:
            ...
            self.past_tau_trajectory.append([thetadot, self.last_u])
        ...
        # After preprocess save information for next step
        self.last_u = action
