...
from agent_pendulum_random import AgentPendulumRandom
...
for use_this_seed in seeds_to_inspect:
    ...
    # Save rewards
    np.savez(f"results/pendulum/random_safety_{START_SAFETY}_{use_this_seed}.npz", 
