...
from agent_rover import AgentRover
...
start_safeties = [70 , 40, 100]
seeds = [42, 43, 44, 45, 46]

for START_SAFETY in start_safeties:
    for seed_to_use in seeds:
        ...
        np.savez(
            f"results/rover/our_safety_{START_SAFETY}_{seed_to_use}.npz",
